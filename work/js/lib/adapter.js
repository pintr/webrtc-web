            ...
            Object.defineProperty(window.RTCPeerConnection.prototype, 'ontrack', {
              ...
              set: function (f) {
                ...
                if (this._ontrack) {
                  ...
                  this.removeEventListener('track', this._ontrackpoly);
                }
                this.addEventListener('track', this._ontrack = f);
                this.addEventListener('track', this._ontrackpoly = function (e) {
                  // ontrack does not fire when a track is added to an existing
